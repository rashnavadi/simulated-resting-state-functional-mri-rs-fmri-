...
noise_levels = [10, 100, 1000, 5000, 10000]; % Adjust these levels as needed
...
for n = 1:num_noise_levels
    ...
    for iter = 1:numIterations
        ...
        gaussian_noise_x = noise_level .* randn(nTimePts, 1);
        gaussian_noise_y = noise_level .* randn(nTimePts, 1);
        gaussian_noise_z = noise_level .* randn(nTimePts, 1);
